...
from yumfoodapp.forms import UserForm, RestaurantForm, UserFormEdit, MealForm
from django.contrib.auth import authenticate, login


from django.contrib.auth.models import User
from yumfoodapp.models import Meal, Order, Driver
...
def restaurant_order(request):
    ...
    return render(request, 'restaurant/order.html',{"ordes": orders})

@login_required(login_url='/restaurant/sign-in/')
def restaurant_report(request):
    # calcular los ingresos y el número de orden por semana actual
